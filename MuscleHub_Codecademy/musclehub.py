...
LEFT JOIN fitness_tests
    ...
    AND visits.last_name = visits.last_name
...
member_pivot['Percent Purchase'] = 1.0 * member_pivot['Member'] / member_pivot['Total']
...
final_member_pivot['Percent Purchase'] = 1.0 * final_member_pivot['Member'] / final_member_pivot['Total']
final_member_pivot
...
plt.title('Percent of Applicants That Purchase a Membership')
...
ax.set_yticks([0, 0.05, 0.1, 0.15, 0.2])
ax.set_yticklabels(['0%', '5%', '10%', '15%', '20%'])
plt.title('Percent of Visitors That Purchase a Membership')
